  ...
  return (
    <>
      <div className="flex h-screen bg-primary">
        <div className="w-[90%] border-r-[1px] border-r-black back bg-primary flex flex-col pl-[24px] justify-around mobileS:items-center  tablet:items-start laptop: laptopL: desktop:gap-[30px]">
          <div>
          ...
          <div className="w-auto mt-[32px] text-white desktop:mt-[28px]">
            ...
            <p className="font-jejumyeongjo text-[12px] mobileL:text-[14px] tablet:text-[16px]laptopL:text-[20px] desktop:text-[24px]">
              한마디 : 목마른 사슴이 시냇물을 찾듯이 성장에 목마른 주니어 개발자
              박진입니다.
            </p>
          </div>
        </div>
